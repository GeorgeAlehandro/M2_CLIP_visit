...
model <- vv$loadModel("/data/dynamo_files/results/models/5000_cells_100_features.json","/data/dynamo_files/results/models/5000_cells_100features.h5")
...
originalPCA_plus_velocity <- tv1_dyno_data$data + 0.06*velocity 
vaevictis_points <- as.data.frame(model[[2]](tv1_dyno_data$data))
...
tv1_dyno_data$layout$lay<-vaevictis_points
